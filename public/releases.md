...
**Current channels:** stable is `1.8.7`; the opt-in beta preview is `1.8.8b10`.
...
## Tested by strangers, beta 1.8.8b10

Five testers installed 1.8.8b7 and then 1.8.8b9 into empty profiles and used
them as new users; b9 and b10 carry what they found. A stale approval on a
...
[Release notes](/releases/1.8.8b10.md).

Install: `python -m pip install --upgrade 'connectonion==1.8.8b10'`.
