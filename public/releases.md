...
for 1.7 is `1.7.0b5`; the latest opt-in preview is `1.8.0a1`. All three have
...
| `1.7.0b5` | Exact, feature-complete 1.7 candidate under release testing |
...
```bash
python -m pip install --upgrade connectonion==1.7.0b5
co --version
```
...
Beta 5 applies the deterministic boundary in both paths. Its exact public wheel
...
access. The coordinated browser production flow remains part of the release
gate in [issue #792](https://github.com/openonion/connectonion/issues/792).
