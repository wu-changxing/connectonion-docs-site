...
|-------|-----|---------|------------|----------|----------|
| False | True/None | Yes | Yes | Yes | Development (default) |
| True | True/None | No | No | Yes | Eval/testing |
| False | False | Yes | No | No | Benchmarking |
| False | "path" | Yes | custom | Yes | Custom log path |
