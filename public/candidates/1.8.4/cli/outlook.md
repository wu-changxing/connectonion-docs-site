...
> **Opt-in 1.8.4b1 preview.** Install `connectonion==1.8.4b1` explicitly.
> Stable 1.8.3 has `co outlook` without the calendar group, without
> `reply --cc/--bcc`, and without the cancel path after a scheduled send.
