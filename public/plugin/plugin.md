...
| Plugin | Purpose | Docs |
|--------|---------|------|
| `re_act` | Planning + reflection (ReAct pattern) | [re_act](/re_act) |
| `eval` | Task evaluation for debugging | [eval](/eval) |
| `image_result_formatter` | Format images for vision models | [image_result_formatter](/image_result_formatter) |
| `shell_approval` | Approve shell commands before execution | [shell_approval](/shell_approval) |
...
For more complex plugins, see [Events](/on_events) for available event hooks.
...
- [llm_do](/llm_do) - Use LLM in handlers
