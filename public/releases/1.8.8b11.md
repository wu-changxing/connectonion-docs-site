...
![co trust and co create now fail with a non-zero exit](https://raw.githubusercontent.com/openonion/connectonion/v1.8.8b11/docs/releases/assets/v1.8.8b11/exit-codes-that-mean-it.png)
