...
> Status: the implementation from ConnectOnion PR #901 is merged and included
> in the reviewed `1.7.0a2` candidate. It is not part of the current stable
> package or publicly available until that preview is published.
