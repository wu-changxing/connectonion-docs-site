...
agent = Agent("prompt", model="co/gpt-4o")           # OpenAI
agent = Agent("prompt", model="co/claude-sonnet-4-20250514")  # Anthropic
agent = Agent("prompt", model="co/gemini-2.0-flash") # Google
```
