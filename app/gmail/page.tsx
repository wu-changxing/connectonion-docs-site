        ...
        <div className="mb-12">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-4">
            <div className="flex items-center gap-3">
              <div className="p-3 bg-gradient-to-br from-red-600/20 to-orange-600/20 rounded-xl border border-red-500/30">
                <Mail className="w-8 h-8 text-red-400" />
              </div>
              <div>
                <h1 className="heading-1">Gmail</h1>
                <p className="text-lg text-gray-300">
                  Give your agents full Gmail access. Read, search, organize, and analyze emails.
                </p>
              </div>
            </div>
            <CopyMarkdownButton markdownPath="/gmail.md" filename="gmail.md" className="flex-shrink-0" />
          </div>
        </div>
...
agent.input("Find emails from alice@example.com")`}
        ...
        <section className="mb-20">
          ...
          <p className="text-gray-300 mb-4">Authenticate with Google:</p>
          <CommandBlock commands={['co auth google']} />

          <p className="text-gray-400 mt-4">Your agent can now read and manage Gmail.</p>
        </section>
          ...
          <div className="space-y-12">
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="bg-gray-900/50 border border-gray-700 rounded-xl p-6">
                  ...
                  <p className="text-gray-300 text-sm mb-3">Read emails from inbox</p>
                ...
                <div className="bg-gray-900/50 border border-gray-700 rounded-xl p-6">
                  ...
                  <p className="text-gray-300 text-sm">Get emails you sent</p>
                </div>

                <div className="bg-gray-900/50 border border-gray-700 rounded-xl p-6">
                  <h4 className="font-semibold text-blue-300 font-mono mb-2">get_all_emails(max_results=50)</h4>
                  <p className="text-gray-300 text-sm">Get emails from all folders (inbox, sent, archive)</p>
                </div>

                <div className="bg-gray-900/50 border border-gray-700 rounded-xl p-6">
                  <h4 className="font-semibold text-blue-300 font-mono mb-2">get_email_body(email_id)</h4>
                  <p className="text-gray-300 text-sm">Get full email content</p>
                </div>

                <div className="bg-gray-900/50 border border-gray-700 rounded-xl p-6">
                  <h4 className="font-semibold text-blue-300 font-mono mb-2">get_email_attachments(email_id)</h4>
                  <p className="text-gray-300 text-sm">List attachments (filename, size)</p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="bg-gray-900/50 border border-gray-700 rounded-xl p-6">
                ...
                <p className="text-gray-300 text-sm mb-3">Search using Gmail query syntax</p>
            ...
            <div>
              ...
              <div className="bg-gray-900/50 border border-gray-700 rounded-xl p-4">
                ...
                <p className="text-gray-400 text-xs">Count unread emails</p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="bg-gray-900/50 border border-gray-700 rounded-xl p-6">
                  ...
                  <p className="text-gray-300 text-sm mb-2">Extract all unique contacts from emails</p>
                  <ul className="text-sm text-gray-400 space-y-1">
                ...
                <div className="bg-gray-900/50 border border-gray-700 rounded-xl p-6">
                  ...
                  <p className="text-gray-300 text-sm mb-2">Analyze specific contact using LLM</p>
                  <ul className="text-sm text-gray-400 space-y-1">
        ...
        <section className="mb-20">
          ...
          <div className="space-y-4">
            <div className="bg-red-900/20 border border-red-500/30 rounded-xl p-4">
              ...
              <p className="text-gray-300 text-sm">Run <code className="bg-gray-800 px-2 py-0.5 rounded">co auth google</code></p>
            </div>
            <div className="bg-red-900/20 border border-red-500/30 rounded-xl p-4">
