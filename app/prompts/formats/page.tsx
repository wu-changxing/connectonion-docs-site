...
print(response)`
  ...
  return (
    <main className="max-w-6xl mx-auto px-8 py-16 md:py-24 lg:py-16 pt-16 lg:pt-20">
      {/* Header */}
            ...
            <div className="flex items-center justify-between bg-gray-800 border-b border-gray-700 px-6 py-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-100">{format.description}</p>
                </div>
                {format.ext && (
      ...
      <section className="mb-16">
        ...
        <div className="bg-gray-900 border border-gray-700 rounded-lg overflow-hidden">
          <div className="flex items-center justify-between bg-gray-800 border-b border-gray-700 px-4 py-3">
            <span className="text-sm text-slate-100 font-mono">Equivalent Usage</span>
            <button
      ...
      <section className="mb-16">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-gray-900 border border-gray-700 rounded-lg p-6">
            <h3 className="font-semibold text-white mb-4">✅ No Vendor Lock-in</h3>
            <p className="text-slate-100">Use any format your team prefers. Switch formats without changing code.</p>
          </div>
          
          <div className="bg-gray-900 border border-gray-700 rounded-lg p-6">
            <h3 className="font-semibold text-white mb-4">✅ Future-Proof</h3>
            <p className="text-slate-100">New formats work automatically. No need to wait for framework updates.</p>
          </div>
          
          <div className="bg-gray-900 border border-gray-700 rounded-lg p-6">
            <h3 className="font-semibold text-white mb-4">✅ Simple</h3>
            <p className="text-slate-100">No complex parsing or schemas. Just reads the text content.</p>
          </div>
          
          <div className="bg-gray-900 border border-gray-700 rounded-lg p-6">
            <h3 className="font-semibold text-white mb-4">✅ Flexible</h3>
            <p className="text-slate-100">Team uses YAML? Use YAML. Prefer Markdown? Use Markdown.</p>
          </div>
        </div>
      </section>
    </main>
