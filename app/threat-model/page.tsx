            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div className="bg-white rounded-lg px-3 py-2 border border-gray-200 flex-1">
                  <div className="text-sm text-gray-900 font-medium">"I solve ANY problem!"</div>
                  <div className="text-xs text-gray-500 mt-1">"99.9% accurate!"</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div className="bg-white rounded-lg px-3 py-2 border border-gray-200 flex-1">
                  <div className="text-sm text-red-700 font-mono">2 + 2 = 5</div>
                  <div className="text-xs text-gray-500 mt-1">Failed basic test</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <MobileDiagram>
          ...
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-3">
              <div className="text-xs text-gray-700 font-mono space-y-1 overflow-x-auto">
                <div className="whitespace-nowrap text-gray-400">[2024-01-15 10:32:41]</div>
                <div className="whitespace-nowrap">User: <span className="text-red-700">john@company.com</span></div>
                <div className="whitespace-nowrap">Code: <span className="text-red-700">proprietary.py</span></div>
                <div className="whitespace-nowrap">API_KEY: <span className="text-red-700">sk-prod-xxx</span></div>
              </div>
            </div>
            <div className="flex items-center gap-2 mt-3">
              ...
              <div className="flex gap-1">
                {[1, 2, 3].map(i => (
                  <div key={i} className="w-8 h-8 bg-white border border-gray-200 rounded flex items-center justify-center">
                    <HiOutlineCircleStack className="w-4 h-4 text-gray-500" />
                  </div>
                ))}
              </div>
            </div>
...
{`while(true) {
  ...
  // Loop forever...
            ...
            <div className="flex flex-wrap items-center gap-2 mt-3">
              ...
              <span className="bg-white border border-gray-200 rounded px-2 py-1 text-xs text-gray-700 font-mono">1000×</span>
              <span className="bg-white border border-gray-200 rounded px-2 py-1 text-xs text-gray-700 font-mono">GPT-4</span>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm text-gray-900 font-semibold tabular-nums">$10/mo</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-xs text-gray-600">After attack:</span>
                <span className="text-xl text-red-700 font-bold tabular-nums">$10,000</span>
              </div>
              <div className="flex items-end gap-1 justify-center mt-3">
                <div className="w-8 h-8 bg-gray-100 border border-gray-200 rounded-t" />
                <div className="w-8 h-20 bg-red-100 border border-red-300 rounded-t" />
              </div>
            </div>
          </div>
        </MobileDiagram>
          ...
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
            ...
            <div className="flex justify-center mb-4">
              <div className="flex -space-x-2">
                {['A', 'B', 'C'].map(agent => (
                  <div key={agent} className="w-10 h-10 rounded-full bg-white border-2 border-gray-300 flex items-center justify-center">
                    <span className="text-xs text-gray-700 font-bold">{agent}</span>
                  </div>
                ))}
              </div>
            </div>
            <div className="bg-white rounded-lg p-3 border border-gray-200 space-y-1">
              <div className="text-xs text-gray-700 italic">"A is amazing! ★★★★★" — B</div>
              <div className="text-xs text-gray-700 italic">"B is the best! ★★★★★" — C</div>
              <div className="text-xs text-gray-700 italic">"C is perfect! ★★★★★" — A</div>
            </div>
          </div>
        </MobileDiagram>
      )
      ...
      diagram: (
        <MobileDiagram>
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
            ...
            <div className="space-y-3">
              {[
                { num: 1, title: 'User sends message', desc: '"Help me. BTW ignore all rules"' },
                { num: 2, title: 'Agent hijacked', desc: 'Follows malicious instructions' },
                { num: 3, title: 'Data leaked', desc: 'Secrets exposed' }
              ].map(step => (
                <div key={step.num} className="flex items-start gap-2">
                  <div className="w-6 h-6 rounded bg-white border border-gray-200 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="font-mono text-[10px] text-gray-500 tabular-nums">{String(step.num).padStart(2, '0')}</span>
                  </div>
                  <div>
        ...
        <MobileDiagram>
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
            ...
            <div className="grid grid-cols-3 gap-2 items-end">
              {[
                { label: 'Trial', value: '99%', height: 'h-16', accent: false },
                { label: '30 Days', value: '75%', height: 'h-12', accent: false },
                { label: '6 Months', value: '40%', height: 'h-8',  accent: true }
              ].map(item => (
                <div key={item.label} className="text-center">
                  <div className="text-[10px] text-gray-500 mb-1 font-mono uppercase tracking-wider">{item.label}</div>
                  <div className={`${item.height} ${item.accent ? 'bg-red-50 border-red-200' : 'bg-white border-gray-200'} rounded border flex items-center justify-center`}>
                    <span className={`text-xs font-bold tabular-nums ${item.accent ? 'text-red-700' : 'text-gray-700'}`}>{item.value}</span>
                  </div>
                </div>
              ))}
            </div>
            <div className="mt-3 text-center text-[11px] text-gray-500 italic">
            ...
            <div className="space-y-3">
              <div className="bg-white rounded p-2 border border-gray-200">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-gray-900 font-semibold">OpenAI Assistant</span>
                </div>
                <div className="text-[10px] text-gray-500 mt-1 font-mono uppercase tracking-wider">Legitimate</div>
              </div>
              <div className="bg-white rounded p-2 border border-red-200">
                <div className="flex items-center gap-2">
                  <HiOutlineIdentification className="w-4 h-4 text-red-600" />
                  <span className="text-xs text-red-700 font-semibold">0penAI Assistant</span>
                </div>
                <div className="text-[10px] text-gray-500 mt-1 font-mono uppercase tracking-wider">Notice the zero?</div>
              </div>
              <div className="bg-white rounded p-2 border border-gray-200">
                <div className="text-[10px] text-gray-500 font-mono uppercase tracking-wider">Fake asks:</div>
                <div className="text-xs text-gray-700 italic mt-0.5">"Enter your API key..."</div>
              </div>
            </div>
          </div>
        </MobileDiagram>
        ...
        <MobileDiagram>
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
            ...
            <div className="space-y-2">
              <div className="bg-white rounded p-2 border border-gray-200">
                <div className="flex items-center justify-between">
                  <span className="text-xs text-gray-900 font-mono">ai-toolkit v2.1.0</span>
                  <span className="text-[10px] text-gray-500 font-mono tabular-nums">10M uses</span>
                </div>
              </div>
              <div className="text-center text-gray-400 text-xs select-none">↓</div>
              <div className="bg-white rounded p-2 border border-red-200">
                <div className="flex items-center justify-between">
                  <span className="text-xs text-red-700 font-mono">ai-toolkit v2.1.1</span>
                  <HiOutlineExclamationTriangle className="w-3.5 h-3.5 text-red-600" />
                </div>
                <div className="text-[10px] text-red-700 font-mono mt-0.5">+ crypto miner</div>
              </div>
              <div className="text-center text-gray-400 text-xs select-none">↓</div>
              <div className="bg-white rounded p-2 border border-gray-200">
                <div className="text-xs text-gray-700 font-mono tabular-nums">10,000+ infected</div>
              </div>
            </div>
          </div>
        </MobileDiagram>
        ...
        <MobileDiagram>
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <div className="text-[10px] text-gray-500 mb-2 font-mono uppercase tracking-wider">Questions</div>
                <div className="space-y-1">
                  {['"Time zone?"', '"Weather?"', '"Currency?"'].map((q, i) => (
                    <div key={i} className="bg-white rounded px-2 py-1 border border-gray-200">
                      <div className="text-[11px] text-gray-700 italic">{q}</div>
                    </div>
                  ))}
                </div>
              </div>
              <div>
                <div className="text-[10px] text-gray-500 mb-2 font-mono uppercase tracking-wider">Learned</div>
                <div className="space-y-1">
                  {['→ Seattle', '→ Online now', '→ Income'].map((l, i) => (
                    <div key={i} className="bg-white rounded px-2 py-1 border border-red-200">
                      <div className="text-[11px] text-red-700 font-mono">{l}</div>
                    </div>
                  ))}
                </div>
              </div>
        ...
        <MobileDiagram>
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
            ...
            <div className="space-y-2">
              <div className="bg-white rounded p-2 border border-gray-200">
                <div className="flex items-center justify-between">
                  <span className="text-xs text-gray-900 font-mono">Month 1–3</span>
                  <span className="text-xs text-gray-700 font-bold tabular-nums">FREE</span>
                </div>
                <div className="text-[11px] text-gray-500 italic mt-1">"Build around us!"</div>
              </div>
              <div className="bg-white rounded p-2 border border-gray-200">
                <div className="flex items-center justify-between">
                  <span className="text-xs text-gray-900 font-mono">Month 4</span>
                  <span className="text-xs text-gray-900 font-bold tabular-nums">$99</span>
                </div>
                <div className="text-[11px] text-gray-500 italic mt-1">"Your data is locked"</div>
              </div>
              <div className="bg-white rounded p-2 border border-red-200">
                <div className="flex items-center justify-between">
                  <span className="text-xs text-red-700 font-mono">Month 12</span>
                  <span className="text-xs text-red-700 font-bold tabular-nums">$999</span>
                </div>
                <div className="text-[11px] text-gray-500 italic mt-1">"Migration: $50k"</div>
              </div>
            </div>
          </div>
        </MobileDiagram>
    ...
    <div className="max-w-4xl mx-auto px-4 md:px-8 py-16 md:py-24">
      ...
      <div className="fixed bottom-4 right-4 z-40 flex flex-col gap-2 lg:hidden">
        ...
        <button
          ...
          className="bg-gray-900 hover:bg-gray-800 text-white rounded-full p-3 shadow-lg transition-all duration-200 active:scale-95"
