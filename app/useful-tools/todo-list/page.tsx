...
todo = TodoList()`}
          ...
          <p className="text-gray-700 mt-4 text-sm">
            Want to customize? Run <Link href="/cli" className="text-gray-500 hover:text-gray-400"><code className="bg-gray-800 px-2 py-1 rounded">co copy todo_list</code></Link> to get an editable copy.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-3">add(content, active_form)</h3>
          <p className="text-gray-700 mb-4">Add a new pending task.</p>
          <CodeWithResult
...
todo.add("Update docs", "Updating docs")`}
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-3 mt-8">start(content)</h3>
          <p className="text-gray-700 mb-4">Mark a task as in_progress. Only one task can be in_progress at a time.</p>
          <CodeWithResult
...
# Shows: ◐ Fixing authentication bug`}
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-3 mt-8">complete(content)</h3>
          <p className="text-gray-700 mb-4">Mark a task as completed.</p>
          <CodeWithResult
...
# Shows: ● Fix authentication bug`}
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-3 mt-8">remove(content)</h3>
          <p className="text-gray-700 mb-4">Remove a task from the list.</p>
          <CodeWithResult
            code={`todo.remove("Update docs")`}
            language="python"
          />

          <h3 className="text-lg font-semibold text-gray-900 mb-3 mt-8">list()</h3>
          <p className="text-gray-700 mb-4">Get all todos as text.</p>
          <CodeWithResult
...
# 4. Show progress throughout`}
        ...
        <section className="mb-12">
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-3">Task Naming</h3>
          <p className="text-gray-700 mb-4">Use both forms:</p>
          <CodeWithResult
            code={`todo.add("Fix authentication bug", "Fixing authentication bug")
#         ^-- content              ^-- active_form`}
            language="python"
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-3 mt-8">One In-Progress at a Time</h3>
          <p className="text-gray-700 mb-4">Only one task should be in_progress. Complete current before starting next.</p>
          <CodeWithResult
