...
assert second["resumed"] is True`}
          ...
          <p className="text-gray-700 mt-4">
            Initialization also requires <code className="bg-gray-100 px-1 rounded">protocolVersion</code> to be the JSON integer <code className="bg-gray-100 px-1 rounded">1</code>. Strings, booleans, and unsupported major versions stop before any session lifecycle request; schema coercion is not protocol agreement.
          </p>
          <p className="text-gray-700 mt-4">
