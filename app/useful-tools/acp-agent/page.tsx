    ...
    <div className="px-4 md:px-8 py-16 md:py-24">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-12 rounded-lg border border-amber-200 bg-amber-50 p-5 text-amber-900">
          The implementation from ConnectOnion PR #901 is merged and included in the reviewed <code className="bg-gray-100 px-1 rounded">1.7.0a2</code> candidate. It is not part of the current stable package or publicly available until that preview is published.
        </div>
...
assert second["resumed"] is True`}
          ...
          <p className="text-gray-700 mt-4">
            Initialization also requires <code className="bg-gray-100 px-1 rounded">protocolVersion</code> to be the JSON integer <code className="bg-gray-100 px-1 rounded">1</code>. Strings, booleans, and unsupported major versions stop before any session lifecycle request. The legacy <code className="bg-gray-100 px-1 rounded">loadSession</code> flag likewise accepts only a JSON boolean or null; strings and numbers are not capabilities. Schema coercion is not protocol agreement.
          </p>
          <p className="text-gray-700 mt-4">
