...
export const metadata: Metadata = {
  ...
  description: 'ConnectOnion supports free managed co/llama and co/gemma models, plus OpenAI, Anthropic, and Gemini. Compare pricing and switch models in one line.',
