...
host(create_agent)  # Reads .co/host.yaml automatically`}
            ...
            <div className="bg-purple-950/50 border border-purple-400/40 rounded-lg p-6">
              <h3 className="text-xl font-semibold text-purple-100 mb-4">Configuration Priority</h3>
              <p className="text-slate-100 mb-4">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm border border-gray-700 rounded-lg">
                  <thead className="bg-gray-800">
                    <tr>
                      <th className="text-left px-4 py-3 text-slate-100 font-semibold">Level</th>
                      <th className="text-left px-4 py-3 text-slate-100 font-semibold">Behavior</th>
                      <th className="text-left px-4 py-3 text-slate-100 font-semibold">Use Case</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-700">
                    <tr>
                      <td className="px-4 py-3 font-mono text-green-300">open</td>
                      <td className="px-4 py-3 text-slate-100">Accept all requests</td>
                      <td className="px-4 py-3 text-slate-300">Development</td>
                    </tr>
                    <tr>
                      <td className="px-4 py-3 font-mono text-yellow-300">careful</td>
                      <td className="px-4 py-3 text-slate-100">Recommend signature, accept unsigned</td>
                      <td className="px-4 py-3 text-slate-300">Staging/Default</td>
                    </tr>
                    <tr>
                      <td className="px-4 py-3 font-mono text-red-300">strict</td>
                      <td className="px-4 py-3 text-slate-100">Require valid signature</td>
...
max_files_per_request: 20`}
                ...
                <div className="bg-purple-950/50 border border-purple-400/40 rounded-lg p-4">
                  <h4 className="font-semibold text-purple-100 mb-2">Video Analysis</h4>
                  <CodeWithResult
