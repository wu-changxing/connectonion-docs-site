        ...
        <section className="mb-16">
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-6">
            <p className="text-lg font-semibold text-gray-900">
              <strong>Quick Start:</strong> Run <code className="bg-white px-2 py-1 rounded border border-green-200">co auth</code> once and start using <code className="bg-white px-2 py-1 rounded border border-green-200">co/gpt-4o</code>, <code className="bg-white px-2 py-1 rounded border border-green-200">co/claude-3-5-sonnet</code>, or <code className="bg-white px-2 py-1 rounded border border-green-200">co/gemini-1.5-pro</code> — no API keys to manage.
            </p>
          </div>
        </section>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-5">
              ...
              <ul className="text-sm text-gray-600 space-y-1 font-mono">
                <li>co/gpt-4o</li>
                <li>co/gpt-4o-mini</li>
              </ul>
            </div>
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-5">
              <h3 className="font-semibold text-gray-900 mb-2">Anthropic</h3>
              <ul className="text-sm text-gray-600 space-y-1 font-mono">
                <li>co/claude-3-5-sonnet</li>
                <li>co/claude-3-5-haiku</li>
              </ul>
            </div>
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-5">
              <h3 className="font-semibold text-gray-900 mb-2">Google</h3>
              <ul className="text-sm text-gray-600 space-y-1 font-mono">
                <li>co/gemini-1.5-pro</li>
                <li>co/gemini-1.5-flash</li>
              </ul>
            </div>
          </div>
        </section>
