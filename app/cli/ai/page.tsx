...
Opening chat.openonion.ai/0x7a9f3b2c...`}
          ...
          <div className="mt-6 bg-white border border-gray-200 rounded-lg p-6">
            ...
            <p className="text-gray-700 mb-3">
              The #901 development implementation registers <code className="bg-gray-100 px-1 rounded">acp_agent</code> for work that specifically needs the common ACP edge instead of the preferred native Claude Code or Codex tools. Engine name, prompt, working directory, and exact session ID are model-visible; command, approval, and workspace root remain operator-owned.
            </p>
            <p className="text-gray-700 mb-3">
