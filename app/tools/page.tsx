...
5. Codecademy Python Course - Hands-on learning`}
      ...
      {/* Function Tools */}
      <section className="mb-14">
        <h2 className="heading-2"><HiOutlineCodeBracket className="w-5 h-5 icon-ui"/>Function Tools</h2>
...
[{'title': 'machine learning 0', 'url': 'https://example.com/0', 'score': 0.9},
 {'title': 'machine learning 1', 'url': 'https://example.com/1', 'score': 0.8}]`}
      ...
      <section className="mb-16">
        <h2 className="heading-2"><HiOutlineComputerDesktop className="w-5 h-5 icon-ui"/>Stateful Tools: Playwright</h2>
        <CodeWithResult 
          code={playwright}
...
['main', 'docs']`}
      ...
      <section className="mb-16">
        <h2 className="heading-2"><HiOutlineCog6Tooth className="w-5 h-5 icon-ui"/>Class Instance vs Individual Methods</h2>
