...
import { Mail, Send, Inbox, ArrowRight, Zap, Check } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gray-950 text-white">
      <div className="max-w-5xl mx-auto px-6 md:px-8 py-16 md:py-24">
        ...
        <div className="flex items-center gap-2 text-sm text-slate-100 mb-8">
          ...
          <span className="text-white">Agent Emails</span>
        </div>
        ...
        <div className="mb-12">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-3">
                  <h1 className="heading-1">Agent Emails</h1>
                  <span className="text-xs bg-green-500/20 text-green-400 px-2 py-1 rounded-full border border-green-500/30">New</span>
                </div>
            ...
            <CopyMarkdownButton markdownPath="/agent-emails.md" filename="agent-emails.md" className="flex-shrink-0" />
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <ArrowRight className="w-5 h-5 text-purple-400 opacity-0 group-hover:opacity-100 transition-opacity ml-auto" />
              </div>
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <ArrowRight className="w-5 h-5 text-blue-400 opacity-0 group-hover:opacity-100 transition-opacity ml-auto" />
              </div>
