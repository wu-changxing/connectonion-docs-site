    ...
    <div className="max-w-4xl mx-auto px-4 py-16 md:py-24">
      ...
      <article className="prose prose-invert max-w-none">
        ...
        <div className="bg-gray-800 rounded-lg p-6 mb-6">
          <h3 className="text-lg font-semibold text-purple-400 mb-4">Addresses are:</h3>
        ...
        <div className="space-y-4 mb-8">
          <div className="bg-gray-800 rounded-lg p-4">
            ...
            <span className="text-slate-100 ml-2">Wallet address (not wallet identity)</span>
          </div>
          <div className="bg-gray-800 rounded-lg p-4">
            <strong className="text-purple-400">Bitcoin:</strong>
            <span className="text-slate-100 ml-2">Bitcoin address (not Bitcoin identity)</span>
          </div>
          <div className="bg-gray-800 rounded-lg p-4">
            <strong className="text-purple-400">TCP/IP:</strong>
            <span className="text-slate-100 ml-2">IP address (not computer identity)</span>
          </div>
          <div className="bg-gray-800 rounded-lg p-4">
            <strong className="text-purple-400">Email:</strong>
            <span className="text-slate-100 ml-2">Email address (not email identity)</span>
          </div>
        </div>
