    ...
    <main className="px-5 md:px-10 py-14 md:py-20">
      ...
      <article className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <p>ConnectOnion 1.7.0 promotes the unchanged RC11 source after the complete installed-artifact gate passed. A Work Room is now a remote client rather than a status panel: it keeps attributed user and provider messages, a persistent composer, current Thinking/Working/approval/Stop/reconnect/terminal state, action summaries with technical details collapsed, and the provider&apos;s own permission choices inside the outer Host ceiling.</p>
