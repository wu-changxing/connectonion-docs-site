      ...
      <div className="max-w-4xl mx-auto">
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="p-4 bg-gray-50 border border-gray-200 rounded-lg">
              <div className="flex items-center gap-2 mb-2">
                <HiOutlineUsers className="w-5 h-5 icon-ui" />
...
CRM updated: john@example.com`}
          ...
          <p className="text-gray-700 mt-4 text-sm">
            Want to customize? Run <Link href="/cli" className="text-gray-500 hover:text-gray-400"><code className="bg-gray-100 px-2 py-1 rounded">co copy gmail_plugin</code></Link> to get an editable copy.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="space-y-3 mb-6">
            ...
            <div className="p-3 bg-gray-100 rounded-lg flex items-start gap-3">
              <HiOutlinePaperAirplane className="w-5 h-5 icon-ui flex-shrink-0 mt-0.5" />
              <div>
                <strong className="text-gray-900">Auto approve emails to '{'{recipient}'}'</strong>
            ...
            <div className="p-3 bg-gray-100 rounded-lg flex items-start gap-3">
              <HiOutlinePaperAirplane className="w-5 h-5 text-gray-500 flex-shrink-0 mt-0.5" />
              <div>
                <strong className="text-gray-900">Auto approve all emails this session</strong>
    ...
    gmail.update_contact(to, last_contact=today, next_contact_date='')`}
        ...
        <section className="mb-12">
          ...
          <div className="flex flex-wrap gap-4">
            <Link href="/gmail" className="p-4 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors">
              <strong className="text-gray-900">Gmail Tool</strong>
              <p className="text-sm text-gray-700">Learn about the Gmail tool itself</p>
            </Link>
            <Link href="/useful-plugins/calendar-plugin" className="p-4 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors">
              <strong className="text-gray-900">Calendar Plugin</strong>
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-700">
            <code className="bg-gray-100 px-2 py-1 rounded">connectonion/useful_plugins/gmail_plugin.py</code>
          </p>
          <CodeWithResult
