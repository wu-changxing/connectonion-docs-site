...
pip install textual textual-autocomplete`}
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-700">
                  <th className="text-left py-2 text-slate-100">Parameter</th>
              ...
              <tbody>
                <tr className="border-b border-gray-700/50">
                  ...
                  <td className="py-2 text-slate-100">Agent</td>
                  <td className="py-2 text-slate-100">ConnectOnion agent instance</td>
                </tr>
                <tr className="border-b border-gray-700/50">
                  <td className="py-2 text-purple-300">handler</td>
                  <td className="py-2 text-slate-100">Callable</td>
                  <td className="py-2 text-slate-100">Custom message handler (alternative to agent)</td>
                </tr>
                <tr className="border-b border-gray-700/50">
                  <td className="py-2 text-purple-300">title</td>
                  <td className="py-2 text-slate-100">str</td>
                  <td className="py-2 text-slate-100">Window title</td>
                </tr>
                <tr className="border-b border-gray-700/50">
                  <td className="py-2 text-purple-300">welcome</td>
                  <td className="py-2 text-slate-100">str</td>
                  <td className="py-2 text-slate-100">Welcome message (markdown supported)</td>
                </tr>
                <tr className="border-b border-gray-700/50">
                  <td className="py-2 text-purple-300">hints</td>
                  <td className="py-2 text-slate-100">list[str]</td>
                  <td className="py-2 text-slate-100">Footer hints</td>
                </tr>
                <tr className="border-b border-gray-700/50">
                  <td className="py-2 text-purple-300">triggers</td>
                  <td className="py-2 text-slate-100">dict</td>
                  <td className="py-2 text-slate-100">Autocomplete triggers (/, @)</td>
                </tr>
                <tr>
                  <td className="py-2 text-purple-300">on_error</td>
                  <td className="py-2 text-slate-100">Callable</td>
                  <td className="py-2 text-slate-100">Custom error handler</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-900 rounded-lg p-4 font-mono text-sm mb-4">
            ...
            <pre className="text-slate-100">⠹ Thinking... 5s (usually 3-10s)</pre>
            <div className="text-emerald-400 mt-4 mb-2">During tool execution:</div>
            <pre className="text-slate-100">{`⠹ Search emails in inbox
...
chat = Chat(
    ...
    triggers={
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-900 rounded-lg p-4 font-mono text-sm mb-4">
            <pre className="text-slate-100">🤖 Assistant    ◐ Thinking (1/10)    co/gpt-4  1,234 tok  $0.0012</pre>
          </div>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-800/50 rounded-lg p-4 overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-700">
                  <th className="text-left py-2 text-slate-100">Widget</th>
              ...
              <tbody>
                <tr className="border-b border-gray-700/50">
                  ...
                  <td className="py-2 text-slate-100">Top status bar</td>
                </tr>
                <tr className="border-b border-gray-700/50">
                  <td className="py-2 text-purple-300">HintsFooter</td>
                  <td className="py-2 text-slate-100">Bottom hints</td>
                </tr>
                <tr className="border-b border-gray-700/50">
                  <td className="py-2 text-purple-300">WelcomeMessage</td>
                  <td className="py-2 text-slate-100">Initial welcome</td>
                </tr>
                <tr className="border-b border-gray-700/50">
                  <td className="py-2 text-purple-300">UserMessage</td>
                  <td className="py-2 text-slate-100">User message bubble</td>
                </tr>
                <tr className="border-b border-gray-700/50">
                  <td className="py-2 text-purple-300">AssistantMessage</td>
                  <td className="py-2 text-slate-100">Agent response</td>
                </tr>
                <tr className="border-b border-gray-700/50">
                  <td className="py-2 text-purple-300">ThinkingIndicator</td>
                  <td className="py-2 text-slate-100">Processing animation</td>
                </tr>
                <tr>
                  <td className="py-2 text-purple-300">TriggerAutoComplete</td>
                  <td className="py-2 text-slate-100">Trigger-based autocomplete</td>
                </tr>
              </tbody>
            </table>
          </div>
