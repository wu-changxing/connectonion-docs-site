/**
 * @purpose Static page content database enabling full-text search across all documentation
 * @llm-note
 *   Dependencies: imports from [] | imported by [lib/enhancedSearch.ts, components/DocsSidebar.tsx]
 *   Data flow: exports pageContentIndex array → consumed by performEnhancedSearch() and performFullTextSearch()
 *   State/Effects: pure data module | no side effects | statically defined at build time
 *   Integration: exposes PageContent interface, pageContentIndex[], performFullTextSearch()
 *   Performance: static array lookup | O(n) search across ~30 pages | scores results by title/url/keywords/content match
 */
