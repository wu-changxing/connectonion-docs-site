...
const MARKDOWN_TO_PAGE_MAP: Record<string, { href: string; section: string; title: string }> = {
  ...
  'tools.md': { href: '/tools', section: 'Agent API', title: 'Tools' },
  'models.md': { href: '/models', section: 'Agent API', title: 'Models' },
  'max_iterations.md': { href: '/max-iterations', section: 'Agent API', title: 'Max Iterations' },
  'max_iterations_guide.md': { href: '/max-iterations', section: 'Agent API', title: 'Max Iterations Guide' },
  'llm_do.md': { href: '/llm_do', section: 'Agent API', title: 'llm_do()' },
  'trust.md': { href: '/trust', section: 'Agent API', title: 'Trust' },
  'xray.md': { href: '/xray', section: 'Advanced', title: 'X-Ray Debugging' },
  'prompts.md': { href: '/prompts', section: 'Agent API', title: 'Prompts' },
  'examples.md': { href: '/examples', section: 'Examples', title: 'Examples' },
  'templates.md': { href: '/examples', section: 'Examples', title: 'Templates' },
  'api.md': { href: '/tools', section: 'Agent API', title: 'API Reference' },
  ...
  'the-owner-needs-a-door.md': { href: '/blog/the-owner-needs-a-door', section: 'Blog', title: 'The Owner Needs a Door' },
  'a-page-should-not-become-a-wall.md': { href: '/blog/a-page-should-not-become-a-wall', section: 'Blog', title: 'A Page Should Not Become a Wall' },
